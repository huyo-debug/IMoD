...
class ModelArguments:  
    # llm
    model_name_or_path: Optional[str] = field(default="pretrain/video-llama2/Mistral-7B-Instruct-v0.2")
    ...
    ## audio module
    BEATs_ckpt_path: str = field(default='pretrain/BEATs_iter3_plus_AS2M_finetuned_on_AS2M_cpt2.pt')
