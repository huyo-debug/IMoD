...
class UnifiedDataset(Dataset):
    ...
    def add_avqa_task_samples(self):
        avqa_data_root = 'avqa_data_root_path/' # TODO: set the avqa data root path
        avqa_annotation_path = avqa_data_root + 'Annotations/music_avqa_valid_train_samples.json'
        tot = 0
        ...
        for sample in samples:
            ...
            _type = sample['type']
            video_path = avqa_data_root + sample['video_path']
            audio_path = avqa_data_root + sample['audio_path']
...
class UnifiedTestDataset(Dataset):
    ...
    def add_avqa_task_samples(self):
        avqa_data_root = 'avqa_data_root_path/' # TODO: set the avqa data root path
        avqa_annotation_path = avqa_data_root + 'Annotations/music_avqa_test_samples.json'
        tot = 0
